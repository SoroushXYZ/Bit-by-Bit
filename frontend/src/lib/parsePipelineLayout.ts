import { NewsletterLayout, Component, HeadlineComponent, SecondaryComponent, QuickLinkComponent, BrandingComponent, GitRepoComponent, StockComponent, BitComponent, DayComponent } from '@/types/components';
  ...
  switch (backendComp.type) {
    case 'headline':
      return {
        ...
        publishedAt: new Date().toISOString(), // Backend doesn't provide this
        priority: 1
    ...
    case 'day_number':
      return {
        ...baseComponent,
        type: 'day',
        day: backendComp.data.day || 'Monday', // Backend doesn't provide day name
